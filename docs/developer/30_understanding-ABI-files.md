...
In the `upcx.token` contract, there's a number of structs that require definition. Please note, not all of the structs are explicitly defined, some correspond to an actions' parameters. Here's a list of structs that require an ABI description for the `upcx.token` contract:
...
### [retire](https://developers.upcx.io/manuals/upcx.contracts/latest/action-reference/upcx.token/index/#retire)
...
### [account](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L120)
...
Describe the actions of the `upcx.token` contract by aggregating all the public functions described in the `upcx.token` contract's [header file](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L1).
...
### [create](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L35-L37)
...
### [issue](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L45-L46)
...
### [retire](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L55-L56)
...
### [transfer](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L67-L71)
...
### [close](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L96-L97)
...
The upcx.token contract instantiates two tables, [accounts](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L134) and [stat](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L135).

The `accounts` table is an i64 index, based on the [`account` struct](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L120-L124), has a [`uint64` as it's primary key](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L123)
...
The `stats` table is an i64 index, based on the [`currency_stats` struct](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L126-L132), has a [`uint64` as it's primary key](https://github.com/UPCX/upcx.contracts/blob/f6578c45c83ec60826e6a1eeb9ee71de85abe976/contracts/upcx.token/include/upcx.token/upcx.token.hpp#L131)
...
You can see an example of base in use in the system contract [source code](https://github.com/UPCX/upcx.contracts/blob/4e4a3ca86d5d3482dfac85182e69f33c49e62fa9/upcx.system/include/upcx.system/upcx.system.hpp#L46) and [ABI](https://github.com/UPCX/upcx.contracts/blob/4e4a3ca86d5d3482dfac85182e69f33c49e62fa9/upcx.system/abi/upcx.system.abi#L262)
